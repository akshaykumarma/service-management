                  ...
                  <tr key={store.id} aria-label={store.name}>
                    ...
                    <td className="store-admins-cell">
                      <ul>
                        ...
                        {assignedAdmins.length === 0 && <li>—</li>}
                      </ul>
                      {/* Deciding who is an Admin of a store is a Super-Admin-level
                          decision (unlike the rest of this row), so this control stays
                          restricted even though the row's other fields are now editable
                          by an Admin too. */}
                      {callerRole === "super_admin" && (
                        <>
                          ...
                          <button
                            type="button"
                            onClick={() => assignAdmin(store.id)}
                            disabled={!selectedAdmin[store.id]}
                          >
                            Assign
                          </button>
                        </>
